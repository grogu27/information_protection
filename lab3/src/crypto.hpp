...
// Вспомогательная функция: проверка, является ли g примитивным корнем по модулю p
bool is_primitive_root(long long g, long long p);

// Вспомогательная функция: генерация случайного примитивного корня по модулю p
